...
namespace PROLab.NBS.Controllers
{
    public class CompanyTypesController : Controller
    {
        ...
        public IActionResult ListCompanyTypes()
        {


            var nBSSettingsViewModel = new NBSSettingsViewModel()
            {
                CompanyTypes = _context.CompanyType
                .ToList()
            };
            return View(nBSSettingsViewModel);
        }
